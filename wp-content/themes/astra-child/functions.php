...
/* my funcs */
function styles_made_by_gulp(){
    wp_enqueue_style('styles.css', get_stylesheet_directory_uri() . '/assets/dist/styles.css', null, time());
}
add_action( 'wp_enqueue_scripts', 'styles_made_by_gulp');
